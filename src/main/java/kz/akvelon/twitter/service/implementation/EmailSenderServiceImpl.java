...
import kz.akvelon.twitter.exception.EmailSendingException;
import kz.akvelon.twitter.service.EmailSenderService;
import kz.akvelon.twitter.util.GenerateLink;
...
public class EmailSenderServiceImpl implements EmailSenderService {
    ...
    public void sendEmail(String email, String username) {
        try {
            ...
            throw new EmailSendingException(HttpStatus.BAD_REQUEST, "Message Exception");
        }
    }
